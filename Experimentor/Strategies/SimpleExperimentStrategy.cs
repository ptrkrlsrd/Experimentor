...
public class BehaviorSelectionStrategy<T> : IExperimentStrategy<T>
{
    ...
    public BehaviorSelectionStrategy(Func<T> controlBehavior, Dictionary<string, Func<T>> candidateBehaviors, Func<string, List<string>, string> strategySelector)
    {
